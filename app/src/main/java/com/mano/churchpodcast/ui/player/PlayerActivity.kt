...
import com.mano.churchpodcast.util.getJsonExtra
...
class PlayerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Click listener
        ControlsClickListener().let {
            playPauseButton.setOnClickListener(it)
            exo_ffwd.setOnClickListener(it)
            exo_rew.setOnClickListener(it)
        }
